  ...
  <div id="container" >
    ...
    <div class="control">
      <a-row>
        ...
        <a-radio-button class="button" value="one">
          type1
        </a-radio-button>
        <a-radio-button class="button" value="two">
          type2
        </a-radio-button>
        <a-radio-button class="button" value="three">
          type3
        </a-radio-button>
      </a-radio-group>
      </a-row>
    ...
    render () {
      ...
      for (let i = 0; i < this.num; i++) {
        if (this.type === 'one' || this.type === 'two') {
          ...
          mat4.rotateX(this.matrixs[i], this.matrixs[i], ((i % 8) * 0.25 - 0.005 * this.time) * Math.PI)
